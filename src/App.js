...
import AddDirectorScreen from './Screen/AddDirectorScreen';
...
function App() {
  ...
  <Router>
    ...
    <main>
      ...
      <Route path='/addmovie' element={<AddProductScreen />} />
      <Route path='/editmovie/:id' element={<EditProductScreen />} />
      <Route path='/addgenre' element={<AddGenreScreen />} />
      <Route path='/genres' element={<GenresScreen />} />
      <Route path='/adddirector' element={<AddDirectorScreen />} />
